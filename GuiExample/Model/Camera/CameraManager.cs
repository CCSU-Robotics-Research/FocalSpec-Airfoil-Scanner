...
namespace FocalSpec.GuiExample.Model.Camera
{
    ...
    public class CameraManager
    {
        ...
        { 
		    ...
		    cameraStatus = _camera.AdjustRoiAndFps(_cameraId, operation, freq, out _);
        ...
        public CameraStatusCode SetFilterValues(bool noiseRemoval, double averageZ, double averageIntensity, int medianZ, int medianIntensity, double reSample, 
        ...
        public CameraStatusCode ReloadSensorParameters()
        {
            ...
            if (status == CameraStatusCode.Ok)
                _parameters.NoiseRemoval = noiseRemoval == 1;
